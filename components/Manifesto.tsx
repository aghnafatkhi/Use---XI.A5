  ...
  return (
    <section id="tentang" className="relative pt-[120px] pb-[120px] md:pt-[160px] md:pb-[160px] px-6 md:px-[6vw] lg:px-[8vw] bg-[var(--bg-color)] graph-paper overflow-hidden">
        ...
        <div className="w-full md:w-[60%] flex flex-col space-y-12 md:space-y-16 lg:pl-[8vw]">
          ...
          <div className="sr-left delay-1">
            <div className="flex flex-col gap-2">
              ...
              <p className="font-instrument italic text-xl md:text-2xl text-[#3A0A0A] mb-2 leading-tight">
                Keunggulan Akademik dan Karakter.
              </p>
              <p className="font-syne text-[13px] md:text-[14px] text-[#5C141499] leading-relaxed max-w-md">
          ...
          {/* Teacher Card */}
          <div className="border-l-2 border-[#C4973A] pl-6 py-3 bg-[#FDFAF599] sr-up delay-4 hover:bg-[#FDFAF5] transition-colors rounded-r-md">
            <p className="font-syne-mono text-[9px] text-[#C4973A] uppercase tracking-widest mb-2">WALI KELAS</p>
            <p className="font-syne font-bold text-[#3A0A0A] text-lg uppercase tracking-tight">Hugi Barkah Pambudi</p>
            <p className="text-[11px] text-[#5C1414CC] opacity-60 font-syne-mono tracking-tighter italic">FISIKA • SMAN 1 CILEUNGSI</p>
          </div>
      ...
      <div className="mt-24 md:mt-32 max-w-7xl mx-auto bg-[#5C1414] relative z-[50] flex flex-col md:flex-row items-center justify-between px-8 md:px-12 py-10 rounded-[4px] border border-[#C4973A4D] sr-up delay-2 gap-8 md:gap-0 shadow-lg">
        ...
        <div className="w-full md:w-auto md:text-right border-t border-[#F4EDE01A] md:border-t-0 pt-8 md:pt-0">
